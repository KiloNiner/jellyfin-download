...
- Shows progress as a TIE fighter chasing an X-wing (which occasionally flips around to fire back) across a scrolling starfield, with size, speed and ETA (set `NO_COLOR` to disable colours)
